...
// Se usi Shopify Admin REST in server-side, importa qui il tuo client
// import { admin } from "../_your_admin_client"; // adatta o rimuovi se non ti serve nel test
...
// Disabilita la body parsing automatica per avere il RAW body
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // 2) TODO: scrivi metafield e tag su Shopify via Admin REST se necessario
  // await admin....  (lasciato fuori per il test HMAC/route)
